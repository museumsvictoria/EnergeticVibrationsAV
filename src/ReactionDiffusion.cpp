...
//--------------------------------------------------------------
void ReactionDiffusion::createFullScreenQuad()
{
...
void ReactionDiffusion::setup(){
    ...
    reaction_shader_bufA.load("shaders/ReactionDiffusion_BufA");
    reaction_shader_image.load("shaders/ReactionDiffusion_Image");
